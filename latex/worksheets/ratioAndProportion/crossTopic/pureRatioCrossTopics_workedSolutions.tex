...
\textbf{Solution:}\\
Let sides be \( 2x \) and \( 3x \). Perimeter = \( 2(2x+3x) = 10x = 30 \) \( \implies \) \( x = 3 \).\\
...
\textbf{Solution:}\\
Let sides be \( 2x \) and \( 3x \). Area = \( 2x \times 3x = 6x^2 = 54 \) \( \implies \) \( x^2 = 9 \) \( \implies \) \( x = 3 \).\\
...
Area = \( \frac{1}{2} \times 3x \times 4x = 6x^2 = 96 \) \( \implies \) \( x^2 = 16 \) \( \implies \) \( x = 4 \).\\
...
Area = \( 3y \times 4y = 12y^2 = 48 \) \( \implies \) \( y^2 = 4 \) \( \implies \) \( y = 2 \).\\
...
Total area = \( \pi (3x)^2 = 9\pi x^2 = 99\pi \) \( \implies \) \( x^2 = 11 \) \( \implies \) \( x = \sqrt{11} \approx 3.32 \) m.\\
