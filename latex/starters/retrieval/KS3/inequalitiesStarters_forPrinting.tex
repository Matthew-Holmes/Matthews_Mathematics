% ================================================================
% The printable version of latex/starters/retrieval/KS3/inequalitiesStarters.tex
%
...
%------------------------------------------------------------------
\begin{frame}<1>[t]{Starter 1: Inequality Symbols}
...
%------------------------------------------------------------------
\begin{frame}<1>[t]{Starter 2: Inequalities on a Number Line}
\begin{columns}[T,onlytextwidth]
...
%------------------------------------------------------------------
\begin{frame}<1>[t]{Starter 3: Double Inequalities}
\begin{columns}[T,onlytextwidth]
...
%------------------------------------------------------------------
\begin{frame}<1>[t]{Starter 4: Solving Inequalities}
\begin{columns}[T,onlytextwidth]
...
%------------------------------------------------------------------
\begin{frame}<1>[t]{Starter 5: Solving Double Inequalities}
\begin{columns}[T,onlytextwidth]
