% ================================================================
% The printable version of latex/starters/retrieval/KS3/inequalitiesStarters_retrieveAndConnect.tex
%
...
%
%   made from           latex/starters/retrieval/KS3/inequalitiesStarters_retrieveAndConnect.tex
...
%------------------------------------------------------------------
\begin{frame}<1>[t]{Retrieve and Connect: Inequality Symbols}
...
%------------------------------------------------------------------
\begin{frame}<1>[t]{Retrieve and Connect: Inequalities on a Number Line}
\begin{columns}[T,onlytextwidth]
...
%------------------------------------------------------------------
\begin{frame}<1>[t]{Retrieve and Connect: Double Inequalities}
\begin{columns}[T,onlytextwidth]
...
%------------------------------------------------------------------
\begin{frame}<1>[t]{Retrieve and Connect: Solving Inequalities}
\begin{columns}[T,onlytextwidth]
...
%------------------------------------------------------------------
\begin{frame}<1>[t]{Retrieve and Connect: Solving Double Inequalities}
\begin{columns}[T,onlytextwidth]
