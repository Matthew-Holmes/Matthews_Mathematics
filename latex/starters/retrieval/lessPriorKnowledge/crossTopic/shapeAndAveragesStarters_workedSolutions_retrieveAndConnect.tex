% ================================================================
% The Retrieve and Connect version of latex/starters/retrieval/lessPriorKnowledge/crossTopic/shapeAndAveragesStarters_workedSolutions.tex
%
...
%
%   made from           latex/starters/retrieval/lessPriorKnowledge/crossTopic/shapeAndAveragesStarters_workedSolutions.tex
...
%------------------------------------------------
\begin{frame}[label=starter1qs]{Retrieve and Connect: Questions and Short Answers}
...
%------------------------------------------------
\begin{frame}[label=starter2qs]{Retrieve and Connect: Questions and Short Answers}
...
%------------------------------------------------
\begin{frame}[label=starter1work]{Retrieve and Connect 1 -- Q1: Multiplication}
\small
...
\begin{frame}{Retrieve and Connect 1 -- Q2: Adding Fractions}
\small
...
\begin{frame}{Retrieve and Connect 1 -- Q3: Triangle Area}
\small
...
\begin{frame}{Retrieve and Connect 1 -- Q4: Negative Multiplication}
\small
...
\begin{frame}{Retrieve and Connect 1 -- Q5: Mean}
\small
...
\begin{frame}{Retrieve and Connect 1 -- Q6: Fraction of 60}
\small
...
\begin{frame}{Retrieve and Connect 1 -- Q7: Areas of A, B and C}
\small
...
\begin{frame}{Retrieve and Connect 1 -- Q8: Perimeters of A, B and C}
\small
...
\begin{frame}{Retrieve and Connect 1 -- Q9: Mean Area}
\small
...
\begin{frame}{Retrieve and Connect 1 -- Q10: Mean Perimeter}
\small
...
\begin{frame}{Retrieve and Connect 1 -- Q11: Fraction of Total Area}
\small
Total area:
...
%------------------------------------------------
\begin{frame}[label=starter2work]{Retrieve and Connect 2 -- Q1: Multiplication}
\small
\[
8 \times 4 = 32
\]
...
\begin{frame}{Retrieve and Connect 2 -- Q2: Adding Fractions}
\small
...
\begin{frame}{Retrieve and Connect 2 -- Q3: Triangle Area}
\small
Use the triangle area formula:
...
\begin{frame}{Retrieve and Connect 2 -- Q4: Negative Multiplication}
\small
...
\begin{frame}{Retrieve and Connect 2 -- Q5: Mean}
\small
\[
...
\begin{frame}{Retrieve and Connect 2 -- Q6: Fraction of 80}
\small
The required fraction is
...
\begin{frame}{Retrieve and Connect 2 -- Q7: Areas of D, E and F}
\small
...
\begin{frame}{Retrieve and Connect 2 -- Q8: Perimeters of D, E and F}
\small
...
\begin{frame}{Retrieve and Connect 2 -- Q9: Mean Area}
\small
...
\begin{frame}{Retrieve and Connect 2 -- Q10: Mean Perimeter}
\small
...
\begin{frame}{Retrieve and Connect 2 -- Q11: Fraction of Total Area}
\small
Total area:
