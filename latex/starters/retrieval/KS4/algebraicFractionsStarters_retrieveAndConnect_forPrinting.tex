% ================================================================
% The printable version of latex/starters/retrieval/KS4/algebraicFractionsStarters_retrieveAndConnect.tex
%
...
%
%   made from           latex/starters/retrieval/KS4/algebraicFractionsStarters_retrieveAndConnect.tex
...
% ================================================================
% ================================================================
% The Retrieve and Connect version of latex/starters/retrieval/KS4/algebraicFractionsStarters.tex
%
...
%
%   made from           latex/starters/retrieval/KS4/algebraicFractionsStarters.tex
...
%------------------------------------------------------------------
\begin{frame}<1>[t]{Retrieve and Connect: Prime Factors \& HCF}
...
%------------------------------------------------------------------
\begin{frame}<1>[t]{Retrieve and Connect: Index Laws}
\begin{columns}[T,onlytextwidth]
...
%------------------------------------------------------------------
\begin{frame}<1>[t]{Retrieve and Connect: Surds \& Single Brackets}
\begin{columns}[T,onlytextwidth]
...
%------------------------------------------------------------------
\begin{frame}<1>[t]{Retrieve and Connect: Double Brackets}
\begin{columns}[T,onlytextwidth]
...
%------------------------------------------------------------------
\begin{frame}<1>[t]{Retrieve and Connect: LCM \& Fractions}
\begin{columns}[T,onlytextwidth]
