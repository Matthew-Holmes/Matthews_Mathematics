% ================================================================
% The Retrieve and Connect version of latex/starters/retrieval/KS4/algebraicFractionsStarters_workedSolutions.tex
%
...
%
%   made from           latex/starters/retrieval/KS4/algebraicFractionsStarters_workedSolutions.tex
...
\title{Algebraic Fractions: Retrieve and Connects}
\author{}
\date{}
...
% STARTER 1
%------------------------------------------------------------------
\begin{frame}[t]{Retrieve and Connect: Prime Factors \& HCF}
\hypertarget{q-st1}{}
...
% STARTER 2
%------------------------------------------------------------------
\begin{frame}[t]{Retrieve and Connect: Index Laws}
\hypertarget{q-st2}{}
\begin{columns}[T,onlytextwidth]
...
% STARTER 3
%------------------------------------------------------------------
\begin{frame}[t]{Retrieve and Connect: Surds \& Single Brackets}
\hypertarget{q-st3}{}
\begin{columns}[T,onlytextwidth]
...
% STARTER 4
%------------------------------------------------------------------
\begin{frame}[t]{Retrieve and Connect: Double Brackets}
\hypertarget{q-st4}{}
\begin{columns}[T,onlytextwidth]
...
% STARTER 5
%------------------------------------------------------------------
\begin{frame}[t]{Retrieve and Connect: LCM \& Fractions}
\hypertarget{q-st5}{}
\begin{columns}[T,onlytextwidth]
