% ================================================================
% The printable version of latex/starters/retrieval/KS4/algebraicFractionsStarters.tex
%
...
%------------------------------------------------------------------
\begin{frame}<1>[t]{Starter 1: Prime Factors \& HCF}
...
%------------------------------------------------------------------
\begin{frame}<1>[t]{Starter 2: Index Laws}
\begin{columns}[T,onlytextwidth]
...
%------------------------------------------------------------------
\begin{frame}<1>[t]{Starter 3: Surds \& Single Brackets}
\begin{columns}[T,onlytextwidth]
...
%------------------------------------------------------------------
\begin{frame}<1>[t]{Starter 4: Double Brackets}
\begin{columns}[T,onlytextwidth]
...
%------------------------------------------------------------------
\begin{frame}<1>[t]{Starter 5: LCM \& Fractions}
\begin{columns}[T,onlytextwidth]
