...
\begin{enumerate}
  ...
  \item The square has side $3$ cm and area $9$ cm$^2$. A circle has radius $1.5$ cm. Is the circle's area more or less than $9$ cm$^2$? \ashow{Less, we can see that the circle could fit inside the square ($\pi(1.5)^2 \approx 7.07$ cm$^2$.)}
\end{enumerate}
...
\begin{enumerate}
  ...
  \item If the square has a perimeter of 48cm, what is the area of the shaded blue region? \ashow{$30.96$ cm$^2$}
\end{enumerate}
