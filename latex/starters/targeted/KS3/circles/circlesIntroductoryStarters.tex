...
\begin{enumerate}
    ...
    \begin{multicols}{2}
        ...
        \item $4 \times 3.5 \ ?$
  \end{multicols}
  \item Round $3.14159$ to 2 decimal places.
  \item A pencil is $12.8$ cm long. How many millimetres is this?
\end{enumerate}

\begin{enumerate}
  \setcounter{enumi}{4}
  \item Find the perimeter of the rectangle shown.
  \item The perimeter of a square is $26$ cm. What is the length of one side?
  \item  The perimeter of an equilateral triangle is $12.9$ cm. 
    Find the length of one side, and then the perimeter of a regular hexagon with the same side length.
\end{enumerate}
...
\begin{multicols}{2}
  ...
  \item Halve $31.4$
  \end{multicols}
  \item How many centimetres in $1.2$ metres?
  \item True or false? $2.5 \times 4 = 10$
\end{enumerate}

\begin{enumerate}
  \setcounter{enumi}{4}
  \item On the diagram, which line is the \textbf{diameter}? 
    How is it different from a chord?
  \item If the radius of a circle is $7$ cm, what is its diameter?
  \item The diameter of a circle is $18$ mm. Find its radius.
  \item A chord of length $8$ cm is drawn inside a circle of radius $5$ cm.
    Is the chord a diameter? Explain.
\end{enumerate}
...
\begin{multicols}{2}
  ...
  \begin{multicols}{2}
    ...
    \item $90 \div 100$
  \end{multicols}
  \item What is $\frac{1}{4}$ of $360^\circ$?
\end{enumerate}
...
\begin{enumerate}
  ...
  \item Copy the diagram, and draw with labels:
    ...
    \end{itemize}
    \end{multicols}
  \item If the radius is $6$ cm, what is the whole circumference? (Use $\pi \approx 3.14$)
  \item For the sector shown, what fraction of the circumference is the arc length? Calculate the arc length if the whole circle has a circumference of 24cm.
...
\begin{multicols}{2}
  ...
  \item $ 9.42 \div 3$
  \end{multicols}
  \item Round $3.14159265$ to 3 decimal places.
  \begin{multicols}{2}
  \item Double $3.14$
  \item halve $12.56$
  \end{multicols}
...
\begin{enumerate}
  ...
  \item If the diameter is $8$ cm, what is:
    \begin{itemize}
      \item the radius?
      \item the circumference? ($\pi \approx 3.14$)
    \end{itemize}
