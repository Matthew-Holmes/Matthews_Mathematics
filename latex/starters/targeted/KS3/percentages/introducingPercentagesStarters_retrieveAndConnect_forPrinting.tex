% ================================================================
% The printable version of latex/starters/targeted/KS3/percentages/introducingPercentagesStarters_retrieveAndConnect.tex
%
...
%
%   made from           latex/starters/targeted/KS3/percentages/introducingPercentagesStarters_retrieveAndConnect.tex
...
% ================================================================
% ================================================================
% The Retrieve and Connect version of latex/starters/targeted/KS3/percentages/introducingPercentagesStarters.tex
%
...
%------------------------------------------------------------------
\begin{frame}<1>[t]{Retrieve and Connect}
\begin{columns}
\column{0.4\textwidth}
\begin{center}
\vspace{-1.5em}
...
% %------------------------------------------------------------------
% \begin{frame}[t]{Retrieve and Connect: Percentages of Amounts}
% \begin{columns}
...
% %------------------------------------------------------------------
% \begin{frame}[t]{Retrieve and Connect: Percentage Problems}
% \begin{columns}
% \column{0.40\textwidth}
% \begin{center}
% \begin{tikzpicture}[scale=0.85]
...
% %------------------------------------------------------------------
% \begin{frame}[t]{Retrieve and Connect: Fractions, Decimals and Percentages}
% \vspace{-2em}
% \begin{columns}
...
% %------------------------------------------------------------------
% \begin{frame}[t]{Retrieve and Connect: Review}
% \vspace{-2.5em}
% \begin{columns}
