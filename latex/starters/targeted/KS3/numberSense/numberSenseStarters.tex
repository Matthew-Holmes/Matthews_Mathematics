...
\begin{enumerate}\qtight
  ...
  \item Fill in $<$ or $>$: $7 \mathrel{\ashowq{<}} 12$, $30 \mathrel{\ashowq{>}} 3$
  ...
  \item Fill in $<$, $>$ or $=$: $0.4 \mathrel{\ashowq{=}} 0.40$, $0.6 \mathrel{\ashowq{>}} 0.06$
...
\begin{enumerate}\qtight
  ...
  \item Which is colder, $-3$ or $-8$? Fill in: $-3 \mathrel{\ashowq{>}} -8$ \ashow{($-8$ is colder)}
  ...
  \item Fill in $<$ or $>$: $-4.5 \mathrel{\ashowq{<}} -4.05$, $-0.3 \mathrel{\ashowq{<}} 0.03$
...
\begin{enumerate}\qtight
  ...
  \item Fill in $<$ or $>$: $-6 \mathrel{\ashowq{<}} -2$
