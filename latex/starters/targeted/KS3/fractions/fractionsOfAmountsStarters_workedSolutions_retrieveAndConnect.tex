...
\textbf{Question:} Use the area model on the left to calculate \(\frac12\times\frac13=\frac{\phantom{1}}{\phantom{6}}\).
...
\textbf{Question:} Use the area model to calculate \(\frac35\times\frac47=\frac{?}{?}\).
