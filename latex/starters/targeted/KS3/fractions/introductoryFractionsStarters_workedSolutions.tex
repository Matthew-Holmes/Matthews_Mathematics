...
\textbf{Worked Solution:} Use denominator $6$: $\frac13 = \frac26$, $\frac16$ stays as $\frac16$, and $\frac12 = \frac36$. Since $1<2<3$, order by the numerators. \ashow{$\frac{1}{6},\ \frac{1}{3},\ \frac{1}{2}$.}
\end{frame}
...
\textbf{Worked Solution:} Use denominator $6$: $\frac23 = \frac{4}{6}$. Since $\frac56 > \frac46$, Lee ate more. \ashow{Lee ate more.}
\end{frame}
...
\textbf{Worked Solution:} Simplify $\frac46$ by dividing numerator and denominator by $2$: $\frac{4 \div 2}{6 \div 2} = \frac23$. \ashow{Equal: $\frac{4}{6}=\frac{2}{3}$.}
\end{frame}
